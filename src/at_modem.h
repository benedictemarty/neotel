 ...
 *
 * Reprise d'OricTel (meme auteur). Les remarques sur l'overrun du 6551 y
 * decrivent le montage Oric + LOCI ; sur le Neo6502 la reception est
 * tamponnee par le firmware (1 Ko), mais la discipline "drainer avant de
 * rendre" est conservee telle quelle : elle ne coute rien et reste juste.
 *
...
/* Raccroche un modem reste EN LIGNE d'une session precedente (Neo6502 resette
 * ou NeoTel relance sans avoir raccroche : le modem est encore en
