 ...
 */
const unsigned char* __fastcall__ font_get_g0(unsigned char ch);
 ...
 * @param ch Code caractere ($20-$7F)
 */
const unsigned char* __fastcall__ font_get_g1(unsigned char ch);

/**
 * Retourne un pointeur vers les 8 octets du glyphe G2.
 * @param ch Code caractere ($20-$7F)
 */
const unsigned char* __fastcall__ font_get_g2(unsigned char ch);
