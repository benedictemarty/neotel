...
- RAM : ~1,6 Ko de marge BSS en v0.5.1, 76 o en v0.8.2, ~1,8 Ko en v0.9.0, 215 o en v0.9.1, **1 255 o en v0.9.2** (cellule 4 octets : `color` = fond<<4 | encre, accesseurs `cell_*`)
