...
**v0.3.0 — sprints 1 à 3 livrés.** Minitel 1B complet (Videotex 40 colonnes :
...
DRCS téléchargeables** conformes à la STUM 2, demande de position curseur), réglages persistants sur la carte, menus,
...
make test-host         # 426 assertions : décodeur, modem AT, UI, clavier, affichage, profil/série
